...
namespace FisherMonitor
{
    ...
    internal static class Ver
    {
        ...
        public const string DATE = "(2022-09-29)";
        public const string DESC = "* 第一版开发完成，感谢Zyzsdy的开源工具BiliRoku！";
        public static readonly string OS_VER = "(" + WinVer.SystemVersion.Major + "." + WinVer.SystemVersion.Minor + "." + WinVer.SystemVersion.Build + ")";
        public static readonly string UA = $"FeelyBlog/1.1 FisherMonitor/{VER} {OS_VER} AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.119 Safari/537.36";
    }
